<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('UpdateTitle', ['name' => __('About') ]) }}</h3>
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.home')" class="text-decoration-none">{{ __('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.about.read')" class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('About')) }}</a></li>
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                <label for='input-text1' class='col-sm-2 control-label '> {{ __('Text1') }}</label>
                <input type='text' id='input-text1' wire:model.lazy='text1' class="form-control  @error('text1') is-invalid @enderror" placeholder='' autocomplete='on'>
                @error('text1') <div class='invalid-feedback'>{{ $message }}</div> @enderror
            </div>
            <!-- Title Input -->
            <div class='form-group'>
        ...
        <div class="card-footer">
            ...
            <a href="@route(getRouteName().'.about.read')" class="btn btn-default float-left">{{ __('Cancel') }}</a>
        </div>
    </form>
</div>
