...
class Read extends Component
{
    ...
    protected $listeners = ['testmonialDeleted'];

    public $sortType;
    public $sortColumn;

    public function testmonialDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('testmonial');
        ...
        return view('livewire.admin.testmonial.read', [
            'testmonials' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Testmonial')) ]);
    }
}
